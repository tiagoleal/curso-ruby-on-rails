class ContactsController < ApplicationController
  ...
  def new
    @contact = Contact.new 
    @contact.build_address #constroi um adrress new na view pois é uma tela aninhada
    # @contact.address.build #constroi um adrress new na view pois é uma tela aninhada
  end
  ...
  private
    ...
    def contact_params
      params.require(:contact).permit(:name, :email, :kind_id, :rmk,
        ...
        phones_attributes: [:id, :phone, :_destroy]) #permite deletar um telefone
    end
end
